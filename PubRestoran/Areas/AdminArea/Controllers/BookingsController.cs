...
namespace PubRestoran.Areas.AdminArea.Controllers
{
    public class BookingsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "booking_id,booking_date,booking_party_size,booking_ex_requirements,booking_user_name,booking_user_phone,booking_user_email")] Booking booking)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "booking_id,booking_date,booking_party_size,booking_ex_requirements,booking_user_name,booking_user_phone,booking_user_email")] Booking booking)
        {
            if (ModelState.IsValid)
            {
