...
namespace PubRestoran.Areas.AdminArea.Controllers
{
    public class PostsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "post_id,post_date,post_insides,post_header,post_text,post_img,post_about_inside")] Post post)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "post_id,post_date,post_insides,post_header,post_text,post_img,post_about_inside")] Post post)
        {
            if (ModelState.IsValid)
            {
